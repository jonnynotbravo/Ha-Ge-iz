...
const AttendanceSearch = ({ setTeacherLoggedIn }) => {
  ...
  const handleInputAttendance = (schoolId, studentId) => {
    navigate(`/teacher/input-attendance/${schoolId}/${studentId}`);
  };
        ...
        {searchResults.map((student, index) => {
          return (
            <ul
              ...
              onClick={() => {
                handleInputAttendance(student.school, student.id);
              }}
            >
